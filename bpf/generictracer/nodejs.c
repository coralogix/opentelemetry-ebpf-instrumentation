...
int BPF_KPROBE(obi_uv_fs_access, void *loop, void *req, const char *path) {
    ...
    //
    // 5. manual-span context override / pop (spanbridge.js):
    ...
    //   '-', 'm'  -> format 5 (manual-span override, "-mspan/" follows)
    ...
    // Formats 1 and 2 are exactly 22 characters long; formats 3 and 5 are read
    // directly from user memory in their handlers.
