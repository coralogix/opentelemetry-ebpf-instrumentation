...
static __always_inline __maybe_unused __u64 __bpf_memcmp_builtin(const void *x,
                                                                 const void *y,
                                                                 __u64 len) {
 ...
 */
static __always_inline __maybe_unused __nobuiltin("memcmp") __u64
    bpf_memcmp(const void *x, const void *y, __u64 len) {
