...
const (
	...
	validationTagReverseDNSCacheLen = "reverseDnsCacheLen"
	validationTagReverseDNSCacheTTL = "reverseDnsCacheTTL"
	validationTagListenPollPeriod   = "listenPollPeriod"
)
...
func (c *Config) Validate() error {
	...
	customValidations := CustomValidations{
		...
		validationTagListenPollPeriod:   ValidateListenPollPeriod,
		validationTagReverseDNSCacheLen: flow.ValidateReverseDNSCacheLen,
		validationTagReverseDNSCacheTTL: flow.ValidateReverseDNSCacheTTL,
	}
