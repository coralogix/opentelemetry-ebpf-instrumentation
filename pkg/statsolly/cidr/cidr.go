...
package cidr // import "go.opentelemetry.io/obi/pkg/statsolly/cidr"
...
func DecoratorProvider(g Definitions, input, output *msg.Queue[[]*ebpf.Stat]) swarm.InstanceFunc {
	return func(ctx context.Context) (swarm.RunFunc, error) {
		...
		return func(ctx context.Context) {
			defer output.Close()
			swarms.ForEachInput(ctx, in, glog().Debug, func(stats []*ebpf.Stat) {
...
func (g *ipGrouper) decorate(stat *ebpf.Stat) {
