...
func AppNetworkPort(val int) attribute.KeyValue {
	return attribute.Key(attr.ServerPort).Int(val)
}

func AppNetworkDirection(val string) attribute.KeyValue {
	return attribute.Key(attr.AppNetworkDirection).String(val)
}
