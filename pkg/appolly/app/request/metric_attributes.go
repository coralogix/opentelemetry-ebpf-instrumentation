...
func SourceAddr(val string) attribute.KeyValue {
	return attribute.Key(attr.SrcAddress).String(val)
}

func DestinationAddr(val string) attribute.KeyValue {
	return attribute.Key(attr.DstAddress).String(val)
}
