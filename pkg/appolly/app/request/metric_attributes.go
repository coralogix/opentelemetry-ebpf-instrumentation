...
func AppNetNetns(val int) attribute.KeyValue {
	return attribute.Key(attr.AppNetworkTcpRttNetns).Int(val)
}

func AppNetPort(val int) attribute.KeyValue {
	return attribute.Key(attr.AppNetworkTcpRttPort).Int(val)
}
