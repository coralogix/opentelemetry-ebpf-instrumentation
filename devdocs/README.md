...
- [Telemetry Registry & Semantic-Convention Validation](telemetry-registry.md): how OBI validates emitted attributes/metrics against semconv (weaver live-check + the deterministic static check), how to add new telemetry to `schemas/obi`, and the documented validation exceptions.
