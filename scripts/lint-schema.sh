...
# the definition/2 UnstableFileFormat notice and the deprecated
# --include-unreferenced warning — see that file for the rationale). `--future` promotes pending warnings (e.g. missing examples
