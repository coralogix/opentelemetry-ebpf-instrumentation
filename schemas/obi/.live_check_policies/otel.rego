# Copied unchanged from weaver's default live-check advice policy
# (defaults/policies/live_check_advice/otel.rego at weaver commit 55b482bf, the
# revision of the pinned weaver image). Pointing `advice_policies` at this
# directory replaces the defaults, so they are carried here to keep running.
# Re-sync it when bumping the weaver image.
